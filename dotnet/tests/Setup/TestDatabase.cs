...
namespace Subscrio.AuditLog.Tests.Setup;

public sealed class AuditLogTestContext
{
...
public static class TestDatabase
{
    ...
    public static async Task<AuditLogTestContext> SetupAsync()
    {
        var baseUrl = GetAdminConnectionString();
        var dbName = $"subscrio_audit_test_{Guid.NewGuid():N}";
        ...
        return new AuditLogTestContext
        {
            DbName = dbName,
            ConnectionString = connectionString,
            Subscrio = subscrio
