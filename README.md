# Subscrio Audit Log Extension

TypeScript and .NET implementations of the Subscrio Audit Log extension.

## Packages

- TypeScript (npm `subscrio-audit-log`): [typescript/README.md](typescript/README.md)
- .NET (NuGet `Subscrio.AuditLog`): [dotnet/README.md](dotnet/README.md)
